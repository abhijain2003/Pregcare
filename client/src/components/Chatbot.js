...
const steps = [
    {
        id: "1",
        message: "Hey! I am Tracy a bot, how are you feeling today",
        trigger: "expressions",
    },
    {
        id: "expressions",
    ...
    },
    {
        ...
        options: [
            ...
            { value: "Diary", label: "Diary", trigger: "selectedService" },
            { value: "Counselor", label: "Counselor", trigger: "selectedService" },
    ...
    const handleEnd = ({ steps, values }) => {
        switch (values[values.length - 1]) {
            case "Home":
                ...
                break;
            case "Diary":
                navigate({ pathname: '/diary' })
                break;
            case "Counselor":
                navigate({ pathname: '/counselor' })
                break;
            default:
                break;
        }
